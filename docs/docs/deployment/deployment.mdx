...
![Minimal deployment via Docker](marquez-deployment-architecture-docker.png)

> **Figure 1:** Minimal Marquez deployment via Docker.

#### KUBERNETES

![Minimal deployment via Kubernetes](marquez-deployment-architecture-k8s.png)
...
* [Running Marquez on AWS](running-on-aws)
