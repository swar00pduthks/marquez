...
public class TagResource extends BaseResource {
  ...
  public TagResource(@NonNull ServiceFactory serviceFactory) {
  ...
  public Response list(
    ...
    return Response.ok(new Tags(tagService.findAll(limit, offset))).build();
  }
  ...
  public Response create(@PathParam("name") String name, TagDescription description) {
    ...
    return Response.ok(tagService.upsert(tag)).build();
  }
