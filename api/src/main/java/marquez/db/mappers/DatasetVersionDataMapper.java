...
@Slf4j
public final class DatasetVersionDataMapper implements RowMapper<DatasetVersionData> {
  @Override
  public DatasetVersionData map(@NonNull ResultSet results, @NonNull StatementContext context)
      throws SQLException {
    ...
    datasetVersionData = new DatasetVersionData(datasetVersion);
    datasetVersionData.setCreatedByParentRunUuid(uuidOrNull(results, "createdByParentRunUuid"));
    datasetVersionData.setUuid(uuidOrThrow(results, "uuid"));
